%% Copyright (c)2003-2006 CTeX and all the Contributors to CTeX FAQ.
%% All rights reserved.
%%
...
%%
%% $Id: ctex-faq.tex,v 1.27 2006/11/23 08:59:29 aloft Exp $
%%
\def\faqversion{0.4}

\documentclass{article}
\usepackage{ctex-faq}[2004/05/02]

 \RCS $Revision: 1.27 $
 \RCS $Date: 2006/11/23 08:59:29 $
 \RCS $State: Exp $
